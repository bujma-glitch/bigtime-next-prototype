...
const paths: Record<IconName, ReactNode> = {
  ...
  tag: (
    <>
      <path d="M3 11V5a2 2 0 0 1 2-2h6l9 9a2 2 0 0 1 0 2.83l-5.17 5.17a2 2 0 0 1-2.83 0Z" />
...
export function Icon({ name, size = 18, title }: IconProps) {
  const filled = name === "bolt" || name === "play" || name === "dots";
  return (
    <svg
      width={size}
      height={size}
      ...
      stroke="currentColor"
      strokeWidth={filled ? 0 : size <= 16 ? 1.6 : 1.5}
      strokeLinecap="round"
